...
@ApiResponse(responseCode = "200", description = "Магазин получен или обновлен", content = @Content)
@ApiResponse(responseCode = "201", description = "Магазин создан", content = @Content)
@ApiResponse(responseCode = "204", description = "Магазин удален", content = @Content)
...
@Operation
public @interface SwaggerAnnotationForShop {
